            ...
            <div className="h-full ml-14 mt-14 mb-10 md:ml-64">
                ...
                />
                                ...
                                <div className="bg-white shadow-md rounded my-6">
                                    <table className="min-w-max w-full table-auto" name="userTable">
                                        <thead>
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <td className="py-3 px-6 text-center justify-center">
                                                            <button type="button" onClick={()=>{handleStatus(setId(data._id))}} ><span className='bg-{statusColor}-200 text-purple-600 py-1 px-3 rounded-full text-xs'>
                                                                {data.status}
                                                            </span></button>
                                                        </td>
                                                        <td className="py-3 px-6 text-center">
